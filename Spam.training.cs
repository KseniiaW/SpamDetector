...
namespace SpamDetector
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Олег\Downloads\email_dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Subject",outputColumnName:@"Subject")      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Content",outputColumnName:@"Content"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Subject",@"Content"}))      
